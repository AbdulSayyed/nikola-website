...
#########################
DATE_FORMAT = 'yyyy-MM-dd' # no needs for seconds, earlier files generated by nikola have default dats produced
...
##########################################################
#   Use this for exteranl style sheets , the custom.css is already mentioned in template  which we have 
#   copited from existing template.
EXTRA_HEAD_DATA = """
